  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <div className="relative z-10 w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-white/60 group-hover:text-[#38bdf8] group-hover:scale-110 transition-all duration-300 mb-6">
          ...
          <p className="relative z-10 text-[#38bdf8] text-xs font-normal tracking-wide uppercase mb-3 font-sans">Office of the University Registrar</p>
          ...
          <div className="absolute right-[-20px] bottom-[-20px] w-32 h-32 bg-gradient-to-br from-[#38bdf8] to-transparent rounded-full opacity-0 blur-2xl group-hover:opacity-30 transition-opacity duration-500 pointer-events-none"></div>
        </motion.div>
        ...
        >
          ...
          <p className="relative z-10 text-[#38bdf8] text-xs font-normal tracking-wide uppercase mb-3 font-sans">Web Application</p>
          <p className="relative z-10 text-white/50 text-sm leading-relaxed font-extralight font-sans">
        ...
        >
          ...
          <p className="relative z-10 text-[#38bdf8] text-xs font-normal tracking-wide uppercase mb-3 font-sans">Desktop Application</p>
          <p className="relative z-10 text-white/50 text-sm leading-relaxed font-extralight font-sans">
